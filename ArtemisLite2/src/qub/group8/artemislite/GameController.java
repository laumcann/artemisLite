...
public class GameController {
	...
	public static void initialiseArtemis(Scanner scanner) {
		...
		/*
		 * Static method of MessageCentre class that displays the opening credits for
		 * the game.
		 */
		...
		do {
			...
			try {
				...
				/*
				 * Static method of MessageCentre class that displays the start menu for the
				 * game.
				 */
				...
				case 1:
					...
					/* Calls the playGame method of the ArtemisLite class. */
				...
				case 2:
					...
					/* Static method of MessageCentre class that displays the rules of the game. */
				...
				case 3:
					...
					/*
					 * Calls the static quitArtemis method of the GameController class. If
					 * quitArtemis returns false, quitGame will become false. If quitArtemis returns
					 * true, quitGame will become true.
					 */
				...
				/*
				 * A message is displayed to the user if they enter a number that isn't between
				 * 1 and 3.
				 */
				default:
	...
	public static boolean quitArtemis(Scanner scanner) {
		...
		/*
		 * boolean variable to assess if the user confirms they want to quit. Initially
		 * set to false.
		 */
		...
		/*
		 * Static method of MessageCentre class that displays a message asking the user
		...
		do {
			...
			try {
				...
				/* Static method of MessageCentre class that displays a confirm quit menu. */
				...
				/* If 1 is entered by the user, confirmQuitGame becomes true. */
				case 1:
				...
				/* If 2 is entered by the user, confirmQuitGame becomes false. */
				case 2:
