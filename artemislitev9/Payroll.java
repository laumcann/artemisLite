...
public class Payroll extends Square {
	...
	/**
	 * Default constructor for Payroll class - Takes no arguments.
	 */
	public Payroll() {
	 ...
	 *                          Payroll object.
	 */
	public Payroll(SquareName squareName, String squareDescription, int squarePositionID, int yearlyBonus)
