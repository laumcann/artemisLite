...
public class Element extends Square {
	...
	/**
	 * int variable which will hold the tax cost of an Element object.
	 * 
	 * Must be a value greater than or equal to 0.
	 */
	private int taxCost;
	...
	/**
	 * Default constructor for Element class - Takes no arguments.
	 */
	public Element() {
	 ...
	 *                                 this Element object.
	 * @param squarePositionID         - int that represents the position on the
	 *                                 virtual game board of this Element object.
	 * @param systemType               - Enum that represents the System type of
	 *                                 this Element object.
	 * @param elementOwned             - boolean that represents if this Element is
	 *                                 owned by a Player.
	 ...
	 *                                 this Element.
	 * @param developmentLevel         - int that represents the development level
	 *                                 of this Element.
	 ...
	 *                                 displayed when this Element is developed to
	 *                                 Level 3 status.
	 * @param taxCost                  - int that represents the tax cost of this
	 *                                 Element.
	 ...
	 */
	public Element(SquareName squareName, String squareDescription, int squarePositionID, SystemType systemType,
			boolean elementOwned, String elementOwner, int purchaseCost, int developmentLevel, int developmentCost,
			String developmentLevel1Message, String developmentLevel2Message, String developmentLevel3Message,
			int taxCost) throws IllegalArgumentException {
		...
		this.setDevelopmentLevel1Message(developmentLevel1Message);
		this.setDevelopmentLevel2Message(developmentLevel2Message);
		this.setDevelopmentLevel3Message(developmentLevel3Message);
		this.setTaxCost(taxCost);
	}
	...
	/**
	 * A method that sets the systemType of an Element object.
	 * 
	...
	/**
	 * A method that sets the developmentLevel1Message of an Element object.
	 * 
	 * @param developmentLevel1Message
	 */
	public void setDevelopmentLevel1Message(String developmentLevel1Message) {
	...
	/**
	 * A method that sets the developmentLevel2Message of an Element object.
	 * 
	 * @param developmentLevel2Message
	 */
	public void setDevelopmentLevel2Message(String developmentLevel2Message) {
	...
	/**
	 * A method that sets the developmentLevel3Message of an Element object.
	 * 
	 * @param developmentLevel3Message
	 */
	public void setDevelopmentLevel3Message(String developmentLevel3Message) {
		this.developmentLevel3Message = developmentLevel3Message;
	}

	/**
	 * A method that returns the taxCost of an Element object.
	 * 
	 * @return the taxCost
	 */
	...
	/**
	 * A method that sets the taxCost of an Element object.
	 * 
	 * @param taxCost - must be greater than or equal to 0.
	 * 
	 * @throws IllegalArgumentException - IllegalArgumentException is thrown if the
	 *                                  taxCost is set to a value of less than 0.
	 */
	public void setTaxCost(int taxCost) throws IllegalArgumentException {
		if (taxCost >= 0) {
			this.taxCost = taxCost;
		} else {
			throw new IllegalArgumentException("Invalid taxCost provided. Must be 0 or greater.");
		}
	}
